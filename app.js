...
function renderLogs() {
  ...
  logs.forEach((log) => {
    ...
    row.querySelector(".date").dataset.label = "日付";
    row.querySelector(".meal").dataset.label = "食事";
    row.querySelector(".memo").dataset.label = "体調";
    row.querySelector(".counts").dataset.label = "便通/尿";
    row.querySelector(".stool").dataset.label = "便の具合";
    row.querySelector(".pain").dataset.label = "腹痛";
    row.querySelector(".stress").dataset.label = "ストレス";
    row.querySelector(".delete").dataset.label = "操作";
